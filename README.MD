...
+ Input Value (GET) : age,birthdate,email,username,role,pwd
-------------------------------------------------------<br/>
...
+ Input Value (GET) : N/A (No Input)
-------------------------------------------------------<br/>

+ Output (POST): userArray (Array of User information)
-------------------------------------------------------<br/>
...
+ Input Value (GET): username,pwd,email,age,birthdate,role
-------------------------------------------------------<br/>
